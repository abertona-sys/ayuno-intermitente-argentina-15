...
interface QuizActivityScreenProps {
  gender: Gender;
...
export const QuizActivityScreen: React.FC<QuizActivityScreenProps> = ({ gender, onNext, onBack }) => {
  const options = [
    { id: 'sedentary', label: 'Trabajo sentada todo el día', emoji: '🪑' },
    { id: 'light', label: 'Camino un poco o hago mandados', emoji: '🚶‍♀️' },
    { id: 'moderate', label: 'Entreno 2 o 3 veces por semana', emoji: '🤸‍♀️' },
    { id: 'active', label: 'No paro un segundo en todo el día', emoji: '⚡' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#E0F7FA] to-white flex flex-col items-center">
      ...
      <div className="w-full max-w-md px-6 flex flex-col items-center text-center flex-grow pb-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-[#004D40] leading-tight mb-8">
          Esa pesadez es justo lo que vamos a atacar. ¿Cómo es tu nivel de movimiento diario?
        </h2>

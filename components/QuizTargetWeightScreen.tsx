...
interface QuizTargetWeightScreenProps {
  unit: 'kg' | 'lb';
  onNext: (targetWeight: string) => void;
  onBack: () => void;
}
...
export const QuizTargetWeightScreen: React.FC<QuizTargetWeightScreenProps> = ({ unit, onNext, onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E0F7FA] to-white flex flex-col items-center">
      ...
      <div className="w-full max-w-md px-4 mt-4 mb-6 flex items-end space-x-3">
        ...
        <ProgressBar currentStep={24} totalSteps={46} />
      </div>

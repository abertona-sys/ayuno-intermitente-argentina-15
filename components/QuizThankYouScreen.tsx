...
export const QuizThankYouScreen: React.FC<QuizThankYouScreenProps> = ({ userName, onNext, onBack }) => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E0F7FA] to-white flex flex-col items-center">
      ...
      <div className="w-full max-w-md px-4 mt-4 mb-6 flex items-end space-x-3">
        ...
        <ProgressBar currentStep={6} totalSteps={46} />
      </div>
      ...
      <div className="w-full max-w-md px-6 flex flex-col items-center text-center pb-8">
        ...
        <p className="text-lg text-slate-500 font-normal leading-relaxed mb-12 max-w-[90%]">
          Ahora vamos a profundizar un poco más para adaptar el plan exactamente a tu metabolismo y estilo de vida.
        </p>

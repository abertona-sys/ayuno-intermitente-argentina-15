...
interface QuizLunchScreenProps {
...
export const QuizLunchScreen: React.FC<QuizLunchScreenProps> = ({ onNext, onBack }) => {
  const options = [
    { id: 'mid_morning', label: 'A media mañana', emoji: '🥐' },
    { id: 'after_lunch', label: 'Después de almorzar', emoji: '🍫' },
    { id: 'afternoon_5pm', label: 'El clásico bajón de las 17hs', emoji: '🕔' },
    { id: 'night_couch', label: 'A la noche tirada en el sillón', emoji: '🛋️' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#E0F7FA] to-white flex flex-col items-center">
      ...
      <div className="w-full max-w-md px-6 flex flex-col items-center text-center flex-grow pb-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-[#004D40] leading-tight mb-8">
          Tomamos nota de eso. ¿En qué momento del día sentís que te cuesta más mantener el control y te da ansiedad por comer?
        </h2>

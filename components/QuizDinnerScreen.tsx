...
interface QuizDinnerScreenProps {
...
export const QuizDinnerScreen: React.FC<QuizDinnerScreenProps> = ({ onNext, onBack }) => {
  const options = [
    { id: 'before_20', label: 'Antes de las 20:00', emoji: '🕗' },
    { id: '20_to_22', label: 'Entre las 20:00 y las 22:00', emoji: '🍲' },
    { id: 'after_22', label: 'Después de las 22:00', emoji: '🌜' },
    { id: 'snack_no_dinner', label: 'Picoteo y no ceno formalmente', emoji: '🥜' },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#E0F7FA] to-white flex flex-col items-center">
      ...
      <div className="w-full max-w-md px-6 flex flex-col items-center text-center flex-grow pb-8">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-[#004D40] leading-tight mb-8">
          Ese horario suele ser crítico para muchas. Y hablando de la noche, ¿a qué hora solés cenar?
        </h2>

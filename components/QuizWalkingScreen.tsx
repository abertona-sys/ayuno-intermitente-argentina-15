...
interface QuizWalkingScreenProps {
  onNext: (walkingTime: string) => void;
  onBack: () => void;
}
...
export const QuizWalkingScreen: React.FC<QuizWalkingScreenProps> = ({ onNext, onBack }) => {
  const options = [
    { id: 'less_15', label: 'Menos de 15 minutos', emoji: '🛋️' },
    { id: '15_to_45', label: 'Entre 15 y 45 minutos', emoji: '🚶' },
    { id: 'more_45', label: 'Más de 45 minutos', emoji: '🏃' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E0F7FA] to-white flex flex-col items-center">
      ...
      <div className="w-full max-w-md px-4 mt-4 mb-6 flex items-end space-x-3">
        ...
        <ProgressBar currentStep={28} totalSteps={46} />
      </div>
